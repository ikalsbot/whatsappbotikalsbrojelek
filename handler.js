        ...
        try {
            ...
            try {
                ...
                if (user) {
                    ...
                    if (!isNumber(user.judiplast)) user.judiplast = 0
                    if (!isNumber(user.reglast)) user.reglast = 0
                    if (!isNumber(user.unreglast)) user.unreglast = 0
                    if (!isNumber(user.snlast)) user.snlast = 0
                    if (!isNumber(user.spinlast)) user.spinlast = 0
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        owner: 'MAU APE LU , KHUSUS OWNER BANH "IKALS,VITA"',
        mods: 'Perintah ini hanya dapat digunakan oleh _*Moderator*_ !',
        premium: '==========================\n_*PREMIUM FITUR TERDETEKSI*_\n==========================\nInfo: Jadilah premium untuk menggunakan perintah ini\n==========================\n*√1 bulan premium | Rp.10.000*\n*√2 bulan premium | Rp.15.000*\n==========================\nMendukung pembayaran melalui\n==========================\n•Gopay    •Dana\n•Dana     •Ovo\n•Qris       •Pulsa\n•DL        •DLL\n==========================\n*NOTE:KETIK #SEWA JIKA BERMINAT*', 
        spremium: '*Undang Bot+Premium*\n1 Bulan *Rp10.000*\n2bulan *Rp15.000*\n\nKetik .sewa kalau minat..', 
